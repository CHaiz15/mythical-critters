...
describe('Medusa', function() {
  ...
  it('should unstone the the first victim and stone the 4th coming in', function() {
    // create medusa
    var medusa = new Medusa('Mom');
    // create first victim
    // create second victim
    // create third victim
    // create fourth victim
    var victim1 = new Person('John');
    var victim2 = new Person('Jim');
    var victim3 = new Person('Jack');
    var victim4 = new Person('Jose');
    ...
    medusa.stare(victim1);
    assert.equal(medusa.stoned, true);
    medusa.stare(victim2);
    medusa.stare(victim3);
    medusa.stare(victim4);
    assert.equal(medusa.stoned, true);
    ...
    medusa.stare(victim1);
    assert.equal(medusa.stoned, false);
  });
})
